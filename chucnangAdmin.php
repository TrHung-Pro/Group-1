...
<body>
    ...
    <div class="khung1">
        <div class="khung2">
            <button class="button" onclick="chuyenTrang('nguoidung')">Người dùng</button>
            <button class="button" onclick="chuyenTrang('dethi')">Đề thi</button>
        </div>
    ...
    function chuyenTrang(chucNang) {
        if (chucNang === 'nguoidung') {
            window.location.href = 'nguoidung.php';
        } else if (chucNang === 'dethi') {
            window.location.href = 'dethi.php';
        }
    }
